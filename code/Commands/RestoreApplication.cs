...
{
    [Serializable]
    public class RestoreApplication : BaseIntelligentSearchCommand
    {
        public virtual void Run(ClientPipelineArgs args)
        {
            ...
            ModalDialogOptions mdo = new ModalDialogOptions($"/SitecoreCognitiveServices/IntelligentSearch/RestoreApplication?id={Id}&language={Language}&db={Db}")
            {
                Header = "Restore Application",
                Height = "200",
                Width = "410",
                Message = "Restore Application",
                Response = true
            };
